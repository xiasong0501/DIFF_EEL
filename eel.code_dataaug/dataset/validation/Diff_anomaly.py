...
class Diff_anomaly(torch.utils.data.Dataset):
    Diff_anomalyClass = namedtuple('Diff_anomaly', ['name', 'id', 'train_id', 'hasinstances',
                                                       'ignoreineval', 'color'])
    # --------------------------------------------------------------------------------
    # A list of all Lost & Found labels
    # --------------------------------------------------------------------------------
    labels = [
        Diff_anomalyClass('in-distribution', 0, 0, False, False, (144, 238, 144)),
        Diff_anomalyClass('out-distribution', 1, 1, False, False, (255, 102, 102)),
        Diff_anomalyClass('unlabeled', 2, 255, False, True, (0, 0, 0)),
    ]
    ...
    def __init__(self, split='', root="", transform=None):
        ...
        for filename in filenames:
            if os.path.splitext(filename)[1] == '.jpg':
                ...
                self.images.append(os.path.join(root, filename_base_img + '.jpg'))
